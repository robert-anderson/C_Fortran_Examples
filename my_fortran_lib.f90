module my_module
    implicit none
    contains
    function add_func(a, b) result (c) bind(c, name='add_func')
      integer, intent(in) :: a, b
      integer :: c
      c = a+b
    end function add_func

    subroutine add_sub(a, b, c) bind(c, name='add_sub')
      integer, intent(in) :: a, b
    ...
    ! C-interoperable
    subroutine add_explicit_shape_mats(a, b, c, ncol, nrow) bind(c, name='add_explicit_shape_mats')
